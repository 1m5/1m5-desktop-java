...
public class SupportView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Support is on the roadmap. It will enable peers to help assist users with troubleshooting issues.";
