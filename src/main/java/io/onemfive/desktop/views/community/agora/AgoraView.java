package io.onemfive.desktop.views.community.agora;
...
public class AgoraView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Community Store (Agora) is on the roadmap. Multiple stores per community will be supported, each backed by a community DID.";
