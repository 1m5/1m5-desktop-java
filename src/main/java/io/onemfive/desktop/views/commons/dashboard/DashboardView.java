package io.onemfive.desktop.views.commons.dashboard;
...
public class DashboardView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Public Dashboard is on the roadmap. It will provide configurable metrics populated by the whole 1M5 network.";
