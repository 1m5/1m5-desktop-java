...
public class ExchangeView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Public Exchange is on the roadmap. It will provide a means to exchange currencies.";
