...
public class DEXView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Public Decentralized Exchange (DEX) is on the roadmap. It enables a global marketplace to exchange currencies requiring no custodians.";
