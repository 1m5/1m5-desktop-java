...
public class InfovaultSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "InfoVault Service Settings is on the roadmap. Settings will enable changes to the InfoVault service, e.g. location of vault.";
