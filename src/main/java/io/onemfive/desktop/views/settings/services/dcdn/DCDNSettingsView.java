...
public class DCDNSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "DCDN Service Settings is on the roadmap. Settings will enable changes to the DCDN service, e.g. max space allotted.";
