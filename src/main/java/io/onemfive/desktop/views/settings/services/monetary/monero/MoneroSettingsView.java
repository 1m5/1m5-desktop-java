...
public class MoneroSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Monero Service Settings is on the roadmap. Settings will enable changes for configuring integration with Monero.";
