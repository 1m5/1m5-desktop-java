...
public class IdentitySettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Identity Service Settings is on the roadmap. Settings will enable changes to the Identity service, e.g. location to save/load contact identities.";
