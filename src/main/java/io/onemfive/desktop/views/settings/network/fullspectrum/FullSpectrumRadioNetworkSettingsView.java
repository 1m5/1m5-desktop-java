...
public class FullSpectrumRadioNetworkSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Full Spectrum Radio Service Settings is on the roadmap. Settings will enable changes for configuring integration with GNU Radio.";
