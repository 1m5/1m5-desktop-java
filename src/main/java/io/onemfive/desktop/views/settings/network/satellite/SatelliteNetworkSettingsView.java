package io.onemfive.desktop.views.settings.network.satellite;
...
public class SatelliteNetworkSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Satellite Network Service Settings is on the roadmap. Settings will enable changes for configuring integration with supported Satellite networks.";
