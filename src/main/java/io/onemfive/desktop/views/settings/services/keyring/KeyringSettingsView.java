...
public class KeyringSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Keyring Service Settings is on the roadmap. Settings will enable changes to the Keyring service, e.g. access information to signing keys.";
