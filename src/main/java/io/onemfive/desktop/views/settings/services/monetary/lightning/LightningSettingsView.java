...
public class LightningSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Lightning Service Settings is on the roadmap. Settings will enable changes for configuring integration with Lightning.";
