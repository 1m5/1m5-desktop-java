...
public class BisqSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Bisq Service Settings is on the roadmap. Settings will enable changes for configuring integration with Bisq.";
