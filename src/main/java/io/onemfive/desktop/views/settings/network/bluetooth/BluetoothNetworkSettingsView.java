...
public class BluetoothNetworkSettingsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Bluetooth Service Settings is on the roadmap. Settings will enable changes for configuring integration with Bisq.";
