package io.onemfive.desktop.views.personal.agora;
...
public class AgoraView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Personal Store (Agora) is on the roadmap. Multiple stores will be supported, each backed by a local DID.";
