...
public class ContactsView extends ActivatableView {

    private Scene scene;
    private TabPane pane;
    @FXML
    private Tab addTab, detailsTab, listTab;
...
//    private EventHandler<KeyEvent> keyEventEventHandler;
    ...
    protected void initialize() {
        ...
        navigationListener = viewPath -> {
            if (viewPath.size() == 4 && viewPath.indexOf(ContactsView.class) == 2)
                loadView(viewPath.tip());
        };

        tabChangeListener = (ov, oldValue, newValue) -> {
            if(newValue == addTab)
                MVC.navigation.navigateTo(HomeView.class, PersonalView.class, ContactsView.class, AddIdentityView.class);
            else if (newValue == detailsTab)
                MVC.navigation.navigateTo(HomeView.class, PersonalView.class, ContactsView.class, DetailsIdentityView.class);
            else if (newValue == listTab)
                MVC.navigation.navigateTo(HomeView.class, PersonalView.class, ContactsView.class, ListIdentityView.class);
        };
