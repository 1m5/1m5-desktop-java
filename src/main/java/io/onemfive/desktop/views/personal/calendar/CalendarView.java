package io.onemfive.desktop.views.personal.calendar;
...
public class CalendarView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Personal Calendar is on the roadmap. Multiple calendars will be supported for each local DID.";
