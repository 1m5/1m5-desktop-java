...
public class DCDNOpsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "DCDN Ops view is on the roadmap. It will provide operational information on the DCDN network.";
