...
public class BisqOpsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Bisq Ops view is on the roadmap. It will provide operational information on the Bisq monetary exchange network.";
