...
public class IdentityOpsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Identity Ops view is on the roadmap. It will provide operational information on local Identity operations.";
