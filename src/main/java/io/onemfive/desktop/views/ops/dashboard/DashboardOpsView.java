...
public class DashboardOpsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "Dashboard Ops view is on the roadmap. It will support metrics to assist users in operating their 1M5 node effectively and efficiently.";
