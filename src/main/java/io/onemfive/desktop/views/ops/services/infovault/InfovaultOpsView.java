...
public class InfovaultOpsView extends ActivatableView implements TopicListener {
    ...
    protected void initialize() {
        ...
        String note = "InfoVault Ops view is on the roadmap. It will provide operational information on local InfoVault operations.";
